...
ticketCtrl.$inject = ['$scope','$state'];
function ticketCtrl($scope,$state) {
  console.log("Inside ticketCtrl");

  $scope.printTicket=function(customer){
    console.log(customer);
  }
  $scope.printTicket = function() {
    var printContents = document.getElementById('modalData').innerHTML;
